...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner ProjectReference
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &gcpv1alpha1.ProjectReference{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileProjectReference) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Fetch the ProjectReference instance
	...
	// Set ProjectReference instance as the owner and controller
...
func newPodForCR(cr *gcpv1alpha1.ProjectReference) *corev1.Pod {
