...
- `gcp-project-operator-pull-request.yaml`: PR validation
- `gcp-project-operator-push.yaml`: Main branch builds
- `gcp-project-operator-pko-pull-request.yaml`: PKO validation
- `gcp-project-operator-pko-push.yaml`: PKO deployment
...
# tkn pipeline validate -f .tekton/gcp-project-operator-pull-request.yaml
...
```text
CI Status: FAILING
Pipeline: gcp-project-operator-pull-request
Stage: golangci-lint
Error: Exit code 1
